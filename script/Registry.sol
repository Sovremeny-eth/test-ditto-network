...
library Registry {
    ...
    function _137() internal pure returns (Contracts memory) {
        ...
        logics.accountAbstractionLogic = 0x9669F549D62258d8BECbA177a0e809740044fff7;
        //
        ...
        //
        logics.pancakeswapLogic = address(1);
        // not used
        logics.timeCheckerLogic = 0xd17d47ef7BF955F49F0AfFd7be3301544e8dBB9F; //
        logics.priceCheckerLogicUniswap = 0xB794829997d0735640a03eF991ff28cd1a4425EF;
        //
        logics.priceDifferenceCheckerLogicUniswap = 0x34Ce7277f3Aa85c2e0C47BC96f9FcC168aC2d215;
        //
        logics.priceCheckerLogicPancakeswap = address(1);
        // not used
        logics.priceDifferenceCheckerLogicPancakeswap = address(1); // not used
        logics.deltaNeutralStrategyLogic = 0xDFbb101eE8e958961e08B139Db3085f0E9Ac8ed6; //
        ...
        //
        logics.celerCircleBridgeLogic = 0x73D9eb84BaE00A3767C090DB6e7d0C39663e919F;
        //
        logics.uniswapDexCheckerLogic = 0x5A5b365c72D81B8CBFb69996C03eb0d4DBC4A386;
        //
        logics.pancakeswapDexCheckerLogic = address(1);
        // not used

        // Prod
        logics.versionUpgradeLogicProd = 0x6E61122e5D1201f7B73Cb60Af9dc8F3b6b2389A8; //
        ...
        return Contracts({
            ...
            //
            wrappedNative: IWETH9(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270),
            ...
            pancakeswapNFTPositionManager: INonfungiblePositionManager(address(0)),
            aaveAddressesProvider: IPoolAddressesProvider(0xa97684ead0e402dC232d5A977953DF7ECBaB3CDb),
    ...
    function _56() internal pure returns (Contracts memory) {
        ...
        //
        logics.priceCheckerLogicUniswap = 0x1B61420aeA5f653cDF05be35dB033f402B2fb439;
        //
        logics.priceDifferenceCheckerLogicUniswap = 0x94991eD3031770fF147a342dE3bdE29d122b1943;
        //
        logics.priceCheckerLogicPancakeswap = 0xB794829997d0735640a03eF991ff28cd1a4425EF;
        //
        logics.priceDifferenceCheckerLogicPancakeswap = 0x34Ce7277f3Aa85c2e0C47BC96f9FcC168aC2d215;
        //
        logics.deltaNeutralStrategyLogic = address(1);
        // not used
        ...
        //
        logics.celerCircleBridgeLogic = address(1);
        // not used
        logics.uniswapDexCheckerLogic = 0xb399b7453762b2C7C755D21AE3810b575754bF52; //
        logics.pancakeswapDexCheckerLogic = 0x5cEE7F75B20192C5b527aAa7Fd0Fa91389C3CD1F;
        //

        // Prod
        logics.versionUpgradeLogicProd = 0x6c07D39042b2480a512675fdcc10A20756ba2d7B; //
        ...
        return Contracts({
            ...
            wrappedNative: IWETH9(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c),
            uniswapRouter: IV3SwapRouter(0xB971eF87ede563556b2ED4b1C0b0019111Dd85d2),
            uniswapFactory: IUniswapV3Factory(0xdB1d10011AD0Ff90774D0C6Bb92e5C5c8b4461F7),
            uniswapNFTPositionManager: INonfungiblePositionManager(
                0x7b8A01B39D58278b5DE7e48c8449c9f4F5170613
                ),
            pancakeswapRouter: IV3SwapRouter(0x13f4EA83D0bd40E75C8222255bc855a974568Dd4),
            pancakeswapFactory: IUniswapV3Factory(0x0BFbCF9fa4f9C56B0F40a671Ad40E0805A091865),
    ...
    function _42161() internal pure returns (Contracts memory) {
        ...
        logics.vaultUpgradeLogic = 0xB5047973F9922d04d7d69dC5A2DCd350A51A1833; //
        logics.accountAbstractionLogic = 0xAA382401E12b52c8D19e77D94E5f83c8929513b0;
        //
        ...
        logics.priceCheckerLogicUniswap = 0x71117ef2ab65D1272605C2CCD87CB03F545AfE15;
        //
        logics.priceDifferenceCheckerLogicUniswap = 0xb399b7453762b2C7C755D21AE3810b575754bF52;
        //
        logics.priceCheckerLogicPancakeswap = address(1);
        // not used
        logics.priceDifferenceCheckerLogicPancakeswap = address(1); // not used
        logics.deltaNeutralStrategyLogic = 0x5cEE7F75B20192C5b527aAa7Fd0Fa91389C3CD1F; //
        ...
        //
        logics.celerCircleBridgeLogic = 0x6dc6618be03c1206822783799BB2B76d99C19D43;
        //
        logics.uniswapDexCheckerLogic = 0x69D57dC47561c3bf5C93Cc8a895B00E214C1DFD0;
        //
        logics.pancakeswapDexCheckerLogic = address(1);
        // not used

        // Prod
        logics.versionUpgradeLogicProd = 0x73b302b4b7ee44afC3e50Dceb898E0DE9346D39E; //
        ...
        return Contracts({
            ...
            //
            wrappedNative: IWETH9(0x82aF49447D8a07e3bd95BD0d56f35241523fBab1),
            uniswapRouter: IV3SwapRouter(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45),
            uniswapFactory: IUniswapV3Factory(0x1F98431c8aD98523631AE4a59f267346ea31F984),
            uniswapNFTPositionManager: INonfungiblePositionManager(
                0xC36442b4a4522E871399CD717aBDD847Ab11FE88
    ...
    function _43114() internal pure returns (Contracts memory) {
        ...
        logics.priceCheckerLogicUniswap = 0x7c8D30FA130B8097d6019Ea2fb6cAe5cDc81cf71;
        //
        logics.priceDifferenceCheckerLogicUniswap = 0x3B631ba46C7E0D058F5f34699c8912Cb01b87d2e;
        //
        logics.priceCheckerLogicPancakeswap = address(1);
        // not used
        logics.priceDifferenceCheckerLogicPancakeswap = address(1); // not used
        logics.deltaNeutralStrategyLogic = 0xbf78b516B37A06F39f551B29fb9975A8DF62aa21; //
        ...
        //
        logics.celerCircleBridgeLogic = 0xB5DC840Cc0B26CA136cA91c72656baa0948E384D;
        //
        logics.uniswapDexCheckerLogic = 0x9317c7fDe9B39bd7Af49e0c957106fa4371d76D6;
        //
        logics.pancakeswapDexCheckerLogic = address(1);
        // not used

        // Prod
        logics.versionUpgradeLogicProd = 0x244Bb9D0D61D2A56Edc67B2891fDa4F28931c8E8; //
        ...
        return Contracts({
            ...
            //
            wrappedNative: IWETH9(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7),
            // https://gov.uniswap.org/t/deploy-uniswap-v3-on-avalanche/20587/18
            uniswapRouter: IV3SwapRouter(0xbb00FF08d01D300023C629E8fFfFcb65A5a578cE),
            uniswapFactory: IUniswapV3Factory(0x740b1c1de25031C31FF4fC9A62f554A55cdC1baD),
            uniswapNFTPositionManager: INonfungiblePositionManager(
    ...
    function _42220() internal pure returns (Contracts memory reg) {
        ...
        //
        logics.nativeWrapper = address(1);
        // not used
        ...
        logics.priceCheckerLogicUniswap = 0x6813268601CeE8823cDcB067b3810f1A44332041;
        //
        logics.priceDifferenceCheckerLogicUniswap = 0x6dc6618be03c1206822783799BB2B76d99C19D43;
        //
        logics.priceCheckerLogicPancakeswap = address(1);
        // not used
        logics.priceDifferenceCheckerLogicPancakeswap = address(1); // not used
        ...
        logics.celerCircleBridgeLogic = address(1);
        // not used
        logics.uniswapDexCheckerLogic = 0xF4CbA02c42d21eBe833379Af0B1579458634388d; //
        logics.pancakeswapDexCheckerLogic = address(1);
        // not used

        // Prod
        logics.versionUpgradeLogicProd = 0x181061Ad3d55376E3D0822F3F6f55e5d3a565501; //
        logics.entryPointLogicProd = 0x48f90754Da260d77300C84e0232bBce88A9201aC;
        //
        logics.executionLogicProd = address(0);
        //
        logics.stargateLogicProd = address(1);
        // not used
        ...
        return Contracts({
            ...
            uniswapRouter: IV3SwapRouter(0x5615CDAb10dc425a742d643d949a7F474C01abc4),
            uniswapFactory: IUniswapV3Factory(0xAfE208a311B21f13EF87E33A90049fC17A7acDEc),
            uniswapNFTPositionManager: INonfungiblePositionManager(
    ...
    function _8217() internal pure returns (Contracts memory reg) {
        ...
        logics.priceCheckerLogicUniswap = 0x77c2c3eA05BA3D1C049CE95b42BD9ddeC31494f0;
        //
        logics.priceDifferenceCheckerLogicUniswap = 0xC389aabfF3b89C47834Ea53E5977df6A8F912Bf7;
        //
        logics.priceCheckerLogicPancakeswap = address(1);
        // not used
        logics.priceDifferenceCheckerLogicPancakeswap = address(1); // not used
        ...
        logics.celerCircleBridgeLogic = address(1);
        // not used
        logics.uniswapDexCheckerLogic = 0x9596D9BE211Bd9cf93c18bA3E7c19694f01B34A0; //
        logics.pancakeswapDexCheckerLogic = address(1);
        // not used

        // Prod
        logics.versionUpgradeLogicProd = 0xC016C463C93eD4C8CE99c3bDf7b111388f61Ad14; //
        ...
        return Contracts({
            ...
            //
            wrappedNative: IWETH9(0x19Aac5f612f524B754CA7e7c41cbFa2E981A4432),
            uniswapRouter: IV3SwapRouter(0x585D515cC24a57FAAb74d3998E0E0bff3a1c99E6),
            uniswapFactory: IUniswapV3Factory(0xA15Be7e90df29A4aeaD0C7Fc86f7a9fBe6502Ac9),
            uniswapNFTPositionManager: INonfungiblePositionManager(
    ...
    function contractsByChainId(uint256 chainId) internal pure returns (Contracts memory) {
        if (chainId == 137) {
            return _137();
        } else if (chainId == 56) {
            return _56();
