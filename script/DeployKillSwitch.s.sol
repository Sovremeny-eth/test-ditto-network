...
contract DeployKillSwitch is Script {
    address constant EXPECTED_ADDRESS_KILL_SWITCH_VALIDATOR =
        0x7393A7dA58CCfFb78f52adb09705BE6E20F704BC;
    address constant EXPECTED_ADDRESS_KILL_SWITCH_ACTION =
        0x3f38e479304c7F18F988269a1bDa7d646bd48243;
    ...
    function run() public {
        ...
        if (EXPECTED_ADDRESS_KILL_SWITCH_ACTION.code.length == 0) {
            ...
            console.log(
                "KillSwitchAction address: %s", address(EXPECTED_ADDRESS_KILL_SWITCH_ACTION)
            );
        }
        vm.stopBroadcast();
    }
