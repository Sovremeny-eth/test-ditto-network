...
contract ExecutePolicy is IPolicy {
    mapping(
        address permissionValidator
            => mapping(bytes32 permissionId => mapping(address kernel => ExecutionConfig))
    ...
    function registerPolicy(
        ...
        executionConfigs[msg.sender][permissionId][kernel] =
            ExecutionConfig(delay, count, ValidAfter.wrap(startAt));
    }
