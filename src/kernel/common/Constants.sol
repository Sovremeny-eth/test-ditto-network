...
/// @dev Struct hash for the ValidatorApproved struct -> keccak256("ValidatorApproved(bytes4
/// sig,uint256 validatorData,address executor,bytes enableData)")
...
/// @dev Storage pointer inside the kernel storage, with 1 offset, to access directly disblaedMode,
/// disabled date and default validator
bytes32 constant KERNEL_STORAGE_SLOT_1 =
    0x439ffe7df606b78489639bc0b827913bd09e1246fa6802968a5b3694c53e0dd9;
