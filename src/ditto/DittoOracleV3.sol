...
contract DittoOracleV3 is IDittoOracleV3 {
    ...
    function consult(
        ...
        address pool = IUniswapV3Factory(dexFactory).getPool(tokenIn, tokenOut, fee);
        ...
        int24 timeWeightedAverageTick = UniswapOracleLibrary.consultView(pool, uint32(PERIOD));
