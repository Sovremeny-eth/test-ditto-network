...
contract DexLogicLens is IDexLogicLens {
    ...
    function getCurrentSqrtRatioX96(IUniswapV3Pool dexPool) external view returns (uint160) {
    ...
    function fees(
        ...
        (,,,,,, IUniswapV3Pool dexPool) = _getData(nftId, dexNftPositionManager, dexFactory);
    ...
    function tvlInToken1(
        ...
        (uint256 amount0, uint256 amount1) =
            PositionValueMod.total(dexNftPositionManager, nftId, sqrtPriceX96, dexPool);
        uint256 amount0InToken1 = DexLogicLib.getAmount0InToken1(sqrtPriceX96, amount0);
        unchecked {
    ...
    function tvlInToken0(
        ...
        (uint256 amount0, uint256 amount1) =
            PositionValueMod.total(dexNftPositionManager, nftId, sqrtPriceX96, dexPool);
        uint256 amount1InToken0 = DexLogicLib.getAmount1InToken0(sqrtPriceX96, amount1);
        unchecked {
    ...
    function getTargetRE18ForTickRange(
        ...
        (,,, int24 minTick, int24 maxTick,, IUniswapV3Pool dexPool) =
    ...
    function token1AmountForTargetRE18(
        ...
        return DexLogicLib.token1AmountAfterSwapForTargetRE18(
            sqrtPriceX96, amount0, amount1, targetRE18, poolFeeE6
        );
    }
    ...
    function token0AmountForTargetRE18(
        ...
        return DexLogicLib.token0AmountAfterSwapForTargetRE18(sqrtPriceX96, amount1, targetRE18);
    }
