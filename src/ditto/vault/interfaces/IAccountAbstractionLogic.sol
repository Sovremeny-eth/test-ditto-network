...
interface IAccountAbstractionLogic is IAccount {
    ...
    /// @dev This function should be implemented by the subclass to return the current entry point
    ...
    function withdrawDepositToAA(address payable withdrawAddress, uint256 amount) external;
}
