...
interface IVersionUpgradeLogic {
    ...
    /// @dev This function can only be called by vault to upgrade the vault to the specified
    /// version.
    /// @param vaultVersion The version number of the implementation in the factory to which the
