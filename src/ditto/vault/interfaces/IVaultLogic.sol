...
interface IVaultLogic {
    ...
    event WithdrawERC20(address indexed receiver, address indexed token, uint256 amount);
    ...
    function depositERC20(address token, uint256 amount, address depositor) external;
    ...
    function withdrawERC20(address token, address receiver, uint256 amount) external;
