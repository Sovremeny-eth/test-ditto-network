...
interface IEntryPointLogic {
    ...
    /// @dev Callbacks can be used for various tasks like adding workflows or adding native balance
    /// to the vault.
    ...
    /// @dev Callbacks can be used for various tasks like cancel task or removing native balance
    /// from the vault.
