...
interface IStargateLogic {
    ...
    struct StargateLogicStorage {
        /// @notice Temporary value storing the exact number of tokens that were sent through the
        /// startgate protocol.
    ...
    /// @notice Thrown when someone other than the Ditto bridge receiver tries to call a restricted
    /// method.
