...
interface ILayerZeroLogic {
    ...
    /// @dev This function prepares and sends a cross-chain message via the LayerZero
    /// infrastructure.
    ...
    /// @dev This function uses the Multicall pattern to aggregate multiple function calls into a
    /// single transaction.
