...
interface IDeltaNeutralStrategyLogic {
    ...
    /// @param pointer Pointer to the strategy's storage location.
    function initializeWithMint(InitializeWithMintParams memory p, bytes32 pointer) external;
    ...
    function withdraw(uint256 shareE18, uint256 deviationThresholdE18, bytes32 pointer) external;
