...
/// @title IPriceDifferenceCheckerLogicPancakeswap - PriceDifferenceCheckerLogicPancakeswap
/// interface.
interface IPriceDifferenceCheckerLogicPancakeswap is IPriceDifferenceCheckerLogicBase {
    // =========================
    // Initializer
    // =========================
    ...
    function pancakeswapCheckPriceDifference(bytes32 pointer) external returns (bool success);

    /// @notice Checks the percentage difference between the current price and the last checked
    /// price.
    /// @param pointer The bytes32 pointer value.
    /// @return success True if the percentage difference is within an acceptable range.
    function pancakeswapCheckPriceDifferenceView(bytes32 pointer)
        external
        view
    ...
    function pancakeswapGetLocalPriceDifferenceCheckerStorage(bytes32 pointer)
        external
        view
        returns (
            address token0,
