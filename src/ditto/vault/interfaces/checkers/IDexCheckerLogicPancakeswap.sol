...
/// @dev This interface extends IDexCheckerLogicBase and provides methods for PancakeSwap specific
/// operations.
interface IDexCheckerLogicPancakeswap is IDexCheckerLogicBase {
    ...
    function pancakeswapDexCheckerInitialize(uint256 nftId, bytes32 pointer) external;
