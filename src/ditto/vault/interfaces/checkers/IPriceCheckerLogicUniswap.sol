...
interface IPriceCheckerLogicUniswap is IPriceCheckerLogicBase {
    ...
    function uniswapCheckGTTargetRate(bytes32 pointer) external view returns (bool);
    ...
    /// rate.
    function uniswapCheckGTETargetRate(bytes32 pointer) external view returns (bool);
    ...
    function uniswapCheckLTTargetRate(bytes32 pointer) external view returns (bool);
    ...
    function uniswapCheckLTETargetRate(bytes32 pointer) external view returns (bool);
    ...
    /// @param pointer The bytes32 pointer value.
    function uniswapChangeTargetRate(uint256 targetRate, bytes32 pointer) external;
    ...
    function uniswapGetLocalPriceCheckerStorage(bytes32 pointer)
        external
        view
