...
/// @dev This interface extends IDexCheckerLogicBase and provides methods for Uniswap specific
/// operations.
interface IDexCheckerLogicUniswap is IDexCheckerLogicBase {
    ...
    function uniswapDexCheckerInitialize(uint256 nftId, bytes32 pointer) external;
    ...
    function uniswapGetLocalDexCheckerStorage(bytes32 pointer) external view returns (uint256);
}
