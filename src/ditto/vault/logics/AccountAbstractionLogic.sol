...
contract AccountAbstractionLogic is IAccountAbstractionLogic, BaseContract {
    ...
    /// @dev Implements the template method of BaseAccount and validates the user's signature for a
    /// given operation.
    /// @param userOp The user operation to be validated, provided as a `UserOperation` calldata
    /// struct.
    ...
    /// @notice This modifier is marked as internal and can only be called within the contract
    /// itself.
