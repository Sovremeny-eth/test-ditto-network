...
contract VaultLogic is IVaultLogic, BaseContract {
    ...
    /// @inheritdoc IVaultLogic
    function withdrawNative(address receiver, uint256 amount) external onlyOwnerOrVaultItself {
    ...
    /// @inheritdoc IVaultLogic
    function withdrawTotalNative(address receiver) external onlyOwnerOrVaultItself {
    ...
    /// @inheritdoc IVaultLogic
    function withdrawTotalERC20(address token, address receiver) external onlyOwnerOrVaultItself {
