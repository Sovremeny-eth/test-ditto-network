...
import { IPriceDifferenceCheckerLogicUniswap } from
    "../../interfaces/checkers/IPriceDifferenceCheckerLogicUniswap.sol";
    ...
    PriceDifferenceCheckerLogicBase
{
    ...
    function priceDifferenceCheckerUniswapInitialize(
        ...
        _priceDifferenceCheckerInitialize(uniswapPool, percentageDeviation_E3, pointer);
    }
    ...
    /// @inheritdoc IPriceDifferenceCheckerLogicUniswap
    function uniswapCheckPriceDifference(bytes32 pointer)
        external
        onlyVaultItself
