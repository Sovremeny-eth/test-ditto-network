...
import { IPriceDifferenceCheckerLogicPancakeswap } from
    "../../interfaces/checkers/IPriceDifferenceCheckerLogicPancakeswap.sol";
    ...
    BaseContract
{
    ...
    function priceDifferenceCheckerPancakeswapInitialize(
        ...
        _priceDifferenceCheckerInitialize(pancakeswapPool, percentageDeviation_E3, pointer);
    }
    ...
    /// @inheritdoc IPriceDifferenceCheckerLogicPancakeswap
    function pancakeswapCheckPriceDifference(bytes32 pointer)
        external
        onlyVaultItself
