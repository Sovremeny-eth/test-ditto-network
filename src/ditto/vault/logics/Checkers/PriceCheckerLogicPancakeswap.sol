...
import { IPriceCheckerLogicPancakeswap } from
    "../../interfaces/checkers/IPriceCheckerLogicPancakeswap.sol";
    ...
    PriceCheckerLogicBase
{
        ...
        returns (address token0, address token1, uint24 fee, uint256 targetRate, bool initialized)
    {
        ...
        return (pcs.token0, pcs.token1, pcs.fee, pcs.targetRate, pcs.initialized);
    }
}
