...
contract BridgeLogicBase is BaseContract, MulticallBase {
    ...
    /// @dev Retrieves the owner and vault ID from the AccessControlLib and ensures the caller is
    /// authorized.
    ...
    function _validateBridgeCall(bytes4 errorSelector)
        internal
        view
        returns (address owner, uint16 vaultId)
    {
