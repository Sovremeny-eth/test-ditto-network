...
contract PancakeswapLogic is IPancakeswapLogic, DexBaseLogic, BaseContract {
    ...
    constructor(
        ...
        IWETH9 _wNative
    ) DexBaseLogic(_cakeNftPositionManager, _pancakeswapRouter, _pancakeswapFactory, _wNative) { }
    ...
    function pancakeswapChangeTickRange(
        ...
        uint256 newNftId =
            _changeTickRange(newLowerTick, newUpperTick, nftId, deviationThresholdE18);
    ...
    function pancakeswapSwapExactOutputSingle(
        ...
        amountIn =
            _swapExactOutputSingle(tokenIn, tokenOut, poolFee, amountOut, deviationThresholdE18);
    }
    ...
    function pancakeswapSwapToTargetR(
        ...
        (token0Amount, token1Amount) = _swapToTargetR(
            deviationThresholdE18, pancakeswapPool, token0Amount, token1Amount, targetRE18
        );
