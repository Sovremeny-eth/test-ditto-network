...
interface IProtocolFees {
    ...
    event AutomationFeesChanged(uint64 automationFeeGasBps, uint192 automationFeeFix);
    ...
    function getInstantFeesAndTreasury()
        external
        view
        returns (address treasury, uint256 instantFeeGasBps, uint256 instantFeeFix);
    ...
    function getAutomationFeesAndTreasury()
        external
        view
        returns (address treasury, uint256 automationFeeGasBps, uint256 automationFeeFix);
    ...
    function setInstantFees(uint64 instantFeeGasBps, uint192 instantFeeFix) external;
    ...
    function setAutomationFee(uint64 automationFeeGasBps, uint192 automationFeeFix) external;
